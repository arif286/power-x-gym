...
. I build a [Power gym service](https://interior-design-service.web.app/) website. This web site allows user to choose a gym class and get paid for their class. • Integrate stripe payment method. After payment, their information will be saved in the database and they can access their classes.• Conditional rendering use in the user interface that allows users to check their class schedule. In this Projects I use **several tools like**.
